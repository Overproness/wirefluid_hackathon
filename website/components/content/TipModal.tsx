  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="bg-[#0c1324] border-[rgba(134,148,138,0.08)] text-[#dce1fb]">
        <DialogHeader>
          <DialogTitle className="font-heading text-xl">Tip Creator ❤️</DialogTitle>
        </DialogHeader>

        <div className="space-y-4">
          <p className="text-sm text-[#bbcabf]">
            50% goes to the creator, 30% to the revenue pool, 20% to the platform.
          </p>
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={handleTip} disabled={isPending} className="flex-1 primary-gradient text-white">
